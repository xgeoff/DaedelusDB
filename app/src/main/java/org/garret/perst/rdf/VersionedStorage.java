...
{ 
     ...
     */
     public void open(String filePath) { 
         ...
         if (root == null) {
             ...
             root.refPropIndex = db.createIndex(new Class[]{PropDef.class, org.garret.perst.VersionHistory.class}, false);
     ...
     */
    public org.garret.perst.VersionHistory getObject(String uri) {
        return (org.garret.perst.VersionHistory)root.prefixUriIndex.get(uri);
    }
    ...
    public Thing getLatestVersion(String uri) {
        org.garret.perst.VersionHistory vh = (org.garret.perst.VersionHistory)root.prefixUriIndex.get(uri);
     ...
     */
     public Thing createObject(String uri, String type, NameVal[] props) {
         org.garret.perst.VersionHistory vh = (org.garret.perst.VersionHistory)root.prefixUriIndex.get(uri);
         if (vh == null) {
             org.garret.perst.VersionHistory typeVh = null;
    ...
    private Iterator searchReferenceProperty(org.garret.perst.VersionHistory type, String uri, NameVal[] patterns, SearchKind kind, Date timestamp, NameVal prop, boolean compound, PropDef def, ArrayList refs)
    {
        refs.add(def);
     ...
     */ 
     ...
     static class SearchResult implements Iterator {
           ...
           Repeat:
             while (true) { 
                 ...
                 while (iterator.hasNext()) { 
                     ...
                     } else if (curr instanceof org.garret.perst.VersionHistory) {
                         currHistory = ((org.garret.perst.VersionHistory)curr).versions;
                         currVersion = 0;
                         continue Repeat;
                     }                    
                 }
            ...
            NextItem:
             for (int i = 0; i < propVal.length; i++) {
                 ...
                 if (val instanceof String && pattern instanceof String) { 
                     ...
                     if (val instanceof org.garret.perst.VersionHistory
                         && followReference((NameVal)pattern, (org.garret.perst.VersionHistory)val))
                     { 
                         return true;
                     }
                 } else if (pattern instanceof NameVal[]) {
                     if (val instanceof org.garret.perst.VersionHistory) {
                         ...
                         for (int j = 0; j < arr.length; j++) {
                             if (!followReference(arr[j], (org.garret.perst.VersionHistory)val)){
                                 continue NextItem;
                             }
                         }
                         return true;
         ...
         private boolean followReference(NameVal prop, org.garret.perst.VersionHistory vh) {
             if (vh != null) { 
    ...
    private void createMetaType() {
        org.garret.perst.VersionHistory vh = createVersionHistory(Symbols.Metatype, null);
        vh.type = vh;
    ...
    private org.garret.perst.VersionHistory createVersionHistory(String uri, org.garret.perst.VersionHistory type) {
        org.garret.perst.VersionHistory vh = new org.garret.perst.VersionHistory();
        vh.uri = uri;
        vh.type = type;
    ...
    private Thing createObject(Thing type, org.garret.perst.VersionHistory vh, NameVal[] props) {
        ...
        for (int i = 0; i < props.length; i++) { 
            ...
            } else if (val instanceof org.garret.perst.VersionHistory || val == null) {
                root.refPropIndex.put(key, thing);
                if (Symbols.Rectangle.equals(prop.name)) {
                    PropVal[] coord = ((org.garret.perst.VersionHistory)val).getLatest().props;
                    RectangleR2 r = new RectangleR2(((Number)coord[0].val).doubleValue(), 
                                                    ((Number)coord[1].val).doubleValue(), 
                                                    ((Number)coord[2].val).doubleValue(), 
                                                    ((Number)coord[3].val).doubleValue());
