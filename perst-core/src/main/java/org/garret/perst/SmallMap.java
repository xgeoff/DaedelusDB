...
public class SmallMap<K,V> extends PersistentResource implements Map<K,V>
{
    ...
    static class Pair<K,V> implements Entry<K,V>, IValue {
        K key;
        V value;
    ...
    private final class EntryIterator extends ArrayIterator<Entry<K,V>> {
    ...
    transient volatile Set<Entry<K,V>> entrySet = null;
}
